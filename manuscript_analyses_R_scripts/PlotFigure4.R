...
#readsetqvfiles <- c("Figure4Output/ont_epi2me_q28.errorqvstats.txt", "Figure4Output/lc24_apk.errorqvstats.txt", "Figure4Output/hifi_revio_pbmay24.errorqvstats.txt", "Figure4Output/NIST_onso_2024Q1.errorqvstats.txt", "Figure4Output/element_ultraq_jun2024.errorqvstats.txt", "Figure4Output/illumina_2x250.errorqvstats.txt" )
